...
class Author(models.Model):
    ...
    day_of_birth = models.DateField(help_text='Введите дату рождения',
                                    verbose_name='Дата рождения', null=True, blank=True)

    day_of_death = models.DateField(help_text='Введите дату смерти',
...
class Book(models.Model):
    title = models.CharField(max_length=100, help_text='Введите название книги',
                             verbose_name='Название книги')

    genre = models.ForeignKey('Gener', on_delete=models.CASCADE, help_text='Выберите жанр книги',
                              verbose_name='Жанр книги', null=True)

    language = models.ForeignKey('Language', on_delete=models.CASCADE, help_text='Выбрите язык книги',
    ...
    isbn = models.CharField(max_length=13, help_text='ISBN должен содержать 13 символов',
